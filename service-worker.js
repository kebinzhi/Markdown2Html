...
importScripts("/Markdown2Html/workbox-v3.6.3/workbox-sw.js");
workbox.setConfig({modulePathPrefix: "/Markdown2Html/workbox-v3.6.3"});

importScripts(
  "/Markdown2Html/precache-manifest.2a375ca308becf47703b338ba71bfe34.js"
);
...
workbox.routing.registerNavigationRoute("/Markdown2Html/index.html", {
